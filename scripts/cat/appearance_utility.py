...
def init_pattern(cat):
    ...
    if cat.pelt.name in ['Calico', 'Tortie']:
        ...
        cat.tortiebase = choice(['single', 'tabby', 'bengal', 'marbled', 'ticked', 'smoke', 'rosette', 'speckled',  'speckledtabby', 'stain', 'sokoke'])
        ...
        elif cat.tortiebase == 'stain':
            cat.tortiepattern = 'tortiecombo'
...
def init_white_patches(cat):
    ...
    if cat.pelt.colour != 'WHITE' and cat.pelt.name in\
        ['Tortie', 'TwoColour', 'Tabby', 'Speckled', 'Marbled', 'Bengal', 'Ticked', 'Smoke', 'Rosette', 'Speckledtabby', 'Stain', 'Sokoke']:
        non_white_pelt = True
    if cat.pelt.white is True:
        ...
        white_list = [None, little_white, mid_white, high_white, mostly_white, 'FULLWHITE', 'FULLBLACK']
        # inheritance
        # one parent
            ...
            if direct_inherit == 1:
                ...
                if par1.white_patches in point_markings and non_white_pelt\
                    ...
                    if par2.white_patches is None:
                        ...
                        white_patches_choice = random.choices(white_list, weights=(10, 70, 20, 0, 0, 0, 0))
                        ...
                        white_patches_choice = random.choices(white_list, weights=(0, 20, 20, 20, 20, 20, 20))
                    ...
                    if par2.white_patches is None:
                        white_patches_choice = random.choices(white_list, weights=(20, 50, 30, 0, 0, 0, 0))
                    elif par2.white_patches in little_white:
                        white_patches_choice = random.choices(white_list, weights=(5, 55, 40, 0, 0, 0, 0))
                    elif par2.white_patches in mid_white or par2.white_patches in point_markings:
        ...
        # regular non-inheritance white patches generation
            ...
            if pelt_choice == 1 and non_white_pelt:
                cat.white_patches = choice(point_markings)
            elif pelt_choice == 2 and cat.pelt.name in ['Calico', 'TwoColour', 'Tabby', 'Speckled', 'Marbled', 'Bengal', 'Ticked', 'Smoke', 'Rosette', 'Speckledtabby', 'Stain', 'Sokoke']:
                cat.white_patches = choice(mostly_white)
            elif pelt_choice == 3 and cat.pelt.name in ['TwoColour', 'Tabby', 'Speckled', 'Marbled', 'Bengal', 'Ticked', 'Smoke', 'Rosette', 'Speckledtabby', 'Stain', 'Sokoke']\
            and cat.pelt.colour != 'WHITE':
                cat.white_patches = choice(['EXTRA', 'FULLWHITE', 'FULLBLACK'])
                if cat.white_patches == None:
                    cat.pelt.white = False
            else:
                if cat.pelt.name in ['TwoColour', 'Tabby', 'Speckled', 'Marbled', 'Bengal', 'Ticked', 'Smoke', 'Rosette', 'Speckledtabby', 'Stain', 'Sokoke']:
                    white_patches_choice = random.choices(white_list, weights=(0, 30, 30, 30, 10, 0, 0))
